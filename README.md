...
For this attribute and when $$\inline P=10\%$$, PCP selects only the most frequent 688 levels (dashed vertical line) merging the other 10,002 infrequent levels into the "Others" label.
